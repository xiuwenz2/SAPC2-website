...
**Q: Is there a private test set?**  
A: Yes. During the competition, submitted systems will be tested using the test1 set,
and results will be immediately published. After the end of the competition period,
each team's ultimate submission will be tested using the test2 set.  Winners will be
determined based on scores achieved on the test2 set.

**Q: How do I benchmark on the leaderboard?**  
A: Submit your system using the provided template (link) through the CodaBench Challenge page (link) to receive official evaluation and appear on the leaderboard.
